...
function Lights() {
  ...
  // dirLight.position.set(SPACE_SIZE * 5, SPACE_SIZE, SPACE_SIZE * 0.1)
  ...
  const ambientLight = new THREE.AmbientLight(0x404040, 3); // 0x404040 is a soft gray color, 0.5 is the intensity
